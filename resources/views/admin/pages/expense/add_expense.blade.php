                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-panel">
                            <form role="form" class="form-horizontal style-form" onsubmit="return myconfirmation()"
                                action="{{url('submit_expense')}}" method="post" oncopy="return false" oncut="return false"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="number" placeholder="Enter Expense Amount" name="expense_amount"
                                                    id="expense_amount" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">Details</label>
                                            <div class="col-lg-8">
                                                <input type="text" placeholder="Add detail" name="details" id="details" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Expenses Date</label>
                                            <div class="col-lg-4 col-xs-8">
                                                <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2022"
                                                    class="input-append date dpYears">
                                                    <input type="text" readonly="" size="16" class="form-control" name="expenses_date"
                                                        id="expenses_date">
