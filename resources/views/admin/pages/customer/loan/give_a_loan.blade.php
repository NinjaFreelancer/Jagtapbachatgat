...
<body>
                    ...
                    <div class="col-lg-8">
                        <div class="form-panel">
                            ...
                            <form role="form" class="form-horizontal style-form" onsubmit="return myconfirmation()"
                                action="{{url('submit_loan/'.$cus_data->id)}}" method="post" oncopy="return false" oncut="return false"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <input type="text" name='loan_no' value={{$loan_no}} readonly id="loan_amount" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2020"
                                            ...
                                            <input type="text" readonly="" size="16" class="form-control" name="start_date" id="start_date">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2020"
                                            class="input-append date dpYears">
                                            <input type="text" readonly="" size="16" class="form-control" name="old_loan_end_date"
                                                id="old_loan_end_date">
                                            <span class="input-group-btn add-on">
                                                <button class="btn btn-theme" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label
                                        ...
                                        Amount</label>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <input type="number" min="0" step="1" placeholder="Enter The Loan Amount" name="loan_amount"
                                ...
                                <div class="form-group">
                                    <label
                                        ...
                                        Amount</label>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <input type="number" min="0" step="1" placeholder="Enter The Shares Amount" name="shares_amount"
                                            id="shares_amount" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <input type="password" placeholder="Enter The Pin" name="con_pin" id="con_pin" class="form-control"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <script>
        function myconfirmation() {
            ...
            var start_date = document.getElementById("old_loan_end_date").value;
            ...
            if (start_date == '') {
                ...
                alert('Select Loan End Date');
                document.getElementById("old_loan_end_date").style.borderColor = "red";
                document.getElementById("old_loan_end_date").focus();
                return false;
