          ...
          <div class="col-lg-8 col-md-8">
            ...
            <div class="form-panel">
              <form role="form" class="form-horizontal style-form" onsubmit="return myconfirmation()"
                action="{{url('/submit_missed_loan_collection/'.$loan_id)}}" method="post" oncopy="return false"
                oncut="return false" onpaste="return false">
                @csrf
                <div class="centered">
                  <h3>Missed loan collection</h3><br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 detailed">
                      <div class="row centered">
                        <div class="col-md-2">
                          <p>
                            <a href="{{url('/monthly_loan_statement/'.$loan_id)}}" class="btn btn-theme">
                              <span>Back</span>
                            </a>
                          </p>
                        </div>
