    ...
    <section class="container-fluid" id="main-content">
      <section class="wrapper">
        <div style="display: flex;
          ...
          <a href="{{url('/collection_pdf/'.$date)}}" class="btn btn-danger"><span>PDF</span></a>
        </div>
        ...
        <div class="row content-panel">
          <div class="row">
            ...
            <div class="border">
              <form role="form" class="form-horizontal style-form" onsubmit="return myconfirmation()"
                action="{{url('datewise_collection')}}" method="post" oncopy="return false" oncut="return false"
          ...
          <div class="row">
            <div class="col-md-3">
              <h5>Total Daily Collection : {{$total_collection}}</h5>
            </div>
            <div class="col-md-3">
              <h5>Total Loan Collection : {{$total_loan_collection}}</h5>
            </div>
            <div class="col-md-3">
